...
Read and follow the instructions in `${JOBPILOT_SKILLS_ROOT}/shared/auth.md`.

### Step 3: Fill Application Forms

Read and follow the instructions in `${JOBPILOT_SKILLS_ROOT}/shared/form-filling.md`.
